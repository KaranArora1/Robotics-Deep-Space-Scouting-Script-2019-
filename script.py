...
# TODO
    ...
    # Current
        ...
        # Add something that checks team effeciency
        # - Add cross checker
...
columns = {"record#": 0, "teams": 1, "starting_level": 2, "sstorm_action": 3, "bonus": 4, "sstorm_total": 5, "cargo": 6,
           ...
           "foul_pts": 20, "total_pts": 21, "winner": 22, "total_rp": 23, "match#": 24}

# List of necessary labels
    ...
    try:
        for team in range(2):
            ...
            for count in range(8):
                count += 1
                if "Cargo" in str(data["bay" + str(count)]):
                    cargo += 1
                if "Panel" in str(data["bay" + str(count)]):
                    panels += 1
